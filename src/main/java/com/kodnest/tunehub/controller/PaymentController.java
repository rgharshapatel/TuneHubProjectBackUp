...
public class PaymentController {
	...
	public String createOrder(HttpSession session) {
		...
		Order order = null;
		try {
			RazorpayClient razorpay=new RazorpayClient("rzp_test_GbtpXSRMki6FFp", "NoAUoKX6C87gloKdYRqFkOUV");
...
//			userService.updateUser(user);
	...
	public boolean verifyPayment(@RequestParam  String orderId, @RequestParam String paymentId,
		...
		try {
	        ...
	        RazorpayClient razorpayClient = new RazorpayClient("rzp_test_GbtpXSRMki6FFp", 
	        								"NoAUoKX6C87gloKdYRqFkOUV");
	...
	public String paymentSuccess(HttpSession session){
		//session is used to record activity of user constistantly
